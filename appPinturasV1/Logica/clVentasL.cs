...
namespace appPinturasV1.Datos
{
    class clVentasL
    {
        ...
        public string lineasAsteriscos()
        {
            ...
            return linea.AppendLine(lineaAsteri).ToString();
        }
        /// <summary>
        /// Escribe lineas con signo =
        /// </summary>
        /// <returns></returns>
        public string lineasIgual()
        {
            ...
            return linea.AppendLine(lineaIgua).ToString();
        }
        /// <summary>
        /// escribe los encabezados de los articulos
        /// </summary>
        public void EncabezadoVenta()
        {
            linea.AppendLine("ARTICULO        ||PRESENT||CANT||PRECIO");
        }
        /// <summary>
        /// escribe el texto a la izquierda
        /// </summary>
        ...
        public void TextoIzquierda(string texto)
        {
            ...
            {
                int charAct = 0;
                for (int longText = texto.Length; longText > maxChar;longText-= maxChar++)
                {
                    linea.AppendLine(texto.Substring(charAct,maxChar));
                    charAct += maxChar;
                }
                linea.AppendLine(texto.Substring(charAct,texto.Length-charAct));
            }
            else
            {
        ...
        public void TextoDerecha(string texto)
        {
            if (texto.Length > maxChar)
            {
                ...
                string espacios = "";
                for (int i = 0; i < (maxChar - texto.Substring(charAct, texto.Length - charAct).Length); i++)
                {
                    espacios += " ";
                }
                linea.AppendLine(espacios + texto.Substring(charAct, texto.Length - charAct));
            }
            else
            {
                string espacios = "";
        ...
        public void TextoCentro(string texto)
        {
            if (texto.Length > maxChar)
            {
                ...
                string espacios = "";
                int centrar = (maxChar - texto.Substring(charAct, texto.Length - charAct).Length) / 2;
        ...
        /// <summary>
        /// Escribe el texto en los lados
        /// </summary>
        /// <param name="textoIzquierdo"></param>
        /// <param name="textoDerecho"></param>
        public void TextoExtremos(string textoIzquierdo,string textoDerecho)
        {
            string textDer, textIzq, textCompl = "", espacios = "";
            ...
            int numEspacios = maxChar - (textIzq.Length +textDer.Length);
            for (int i = 0; i < numEspacios; i++)
            {
                espacios += "";
            }
            textCompl += espacios + textoDerecho;
            linea.AppendLine(textCompl);
        }
        /// <summary>
        ...
        public void AgregarTotales(string texto, decimal total)
        {
            ...
            int numEspacios = maxChar - (resumen.Length + valor.Length);
